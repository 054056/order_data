...
class Data:
    def main(self):
        train_path = 'data/train/data08_10-16digits.txt'
        interporate_path = 'data/interporate/data08_10-16digits.txt'
    ...
    def gene_question(self, sequence, path):
        ...
        f = open(path, 'a')
        f.write("What is the left number in the ")
        f.write(first_order)
        ...
        f.write("?\n")
        f.write(str(sequence[min_number-1]))
        f.write("\n")
