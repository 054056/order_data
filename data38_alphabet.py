...
class Data:
    def main(self):
        train_path = 'data/train/data38_alphabet.txt'
        interporate_path = 'data/interporate/data38_alphabet.txt'
...
#What is the second in the alphabetical sequence a,b,c,d between the second and fourth?
        ...
        f.write(" from the right in the ")
        f.write(str(length))
        f.write(" alphabetic sequences ")
