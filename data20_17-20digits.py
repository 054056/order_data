...
class Data:
    def main(self):
        train_path = 'data/train/data20_17-20digits.txt'
        interporate_path = 'data/interporate/data20_17-20digits.txt'
    ...
    def gene_question(self, sequence, path):
        ...
        f.write("What is the ")
        f.write(third_order)
        f.write(" from the right between the ")
        f.write(first_order)
        ...
        f.write("?\n")
        f.write(str(sequence[length - (first_order_number+third_order_number)]))
        f.write("\n")
